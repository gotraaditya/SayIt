...
const requiredReleaseEvidenceFragments = [
  ...
  [
    ...
    [
      ...
      "Validation accepted the sample public updater key text: this is unexpected.",
      "Validation accepted the placeholder updater key text: this is unexpected.",
      "Validation accepted the public updater key file: this is unexpected.",
